...
public class DBManager {
    ...
    public boolean login(String userId, String password) {
        String sqlQuery = "select * from user where username ='" + userId +"' AND password = '" +password +"'";
        try {
...
//        Class.forName("com.mysql.jdbc.Driver");
    ...
    public void addFingerPrint(String email, String screenHeight, String screenWidth, String timeZone, String ip, String uaString) {
        try {
            String sqlQuery = "Insert into fingerPrint values(?,?,?,?,?,?,?,?,?)";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString((1), screenHeight);
            preparedStatement.setString((2), screenWidth);
            preparedStatement.setString(3, ip);
            preparedStatement.setString(4, uaString);
            preparedStatement.setString(5, timeZone);
